...
public class WireMockScenarioExampleIntegrationTest {
    ...
    private static final String TIP_01 = "this is First";
    private static final String TIP_02 = "this is Second";
    private static final String TIP_03 = "this is Third";
    ...
    public void changeStateOnEachCallTest() throws IOException {
        ...
        System.out.println(TIP_01);
        System.out.println(TIP_02);
        System.out.println(TIP_03);
